...
const DashboardMockup = () => {
  ...
  const handleDeploy = () => {
    setToast({
      text: "Deployment started for project: vercel-design-system",
      type: "success",
    });
  };
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          ...
          <div>
            ...
            <Text type="secondary" style={{ margin: 0 }}>
              Overview of your current deployment status and metrics.
            </Text>
          </div>
        </div>
        <div style={{ display: "flex", gap: "8px" }}>
          <Snippet text="bun run deploy" type="dark" width="200px" />
          <Button type="success" auto onClick={handleDeploy}>
            Deploy Now
          </Button>
        </div>
      </div>
      ...
      <Note type="warning" label="Alert" filled>
        Your domain is expiring in 3 days. Please renew to avoid service
        interruption.
      </Note>
      ...
      >
        <Card shadow>
          <CardContent>
            ...
            <Text p>
              Your latest build is live and serving traffic globally.
            </Text>
            <div
              style={{
                display: "flex",
          ...
          <CardFooter>
            <Button type="abort" auto scale={0.5}>
              View Logs
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card shadow>
          ...
          <CardFooter>
            <Button type="secondary" auto scale={0.5}>
              Optimize
            </Button>
          </CardFooter>
        </Card>
        ...
        <CardContent>
          <div style={{ display: "flex", gap: "24px", alignItems: "flex-end" }}>
            ...
            <Button
              ...
              auto
              onClick={() =>
                setToast({ text: "Variable added.", type: "success" })
              }
            >
              Add Key
            </Button>
      ...
      <Modal {...bindings}>
        ...
        <Modal.Content>
          <Text p>
            Are you sure you want to terminate the production deployment? This
            will immediately stop all traffic to the current build.
          </Text>
        </Modal.Content>
