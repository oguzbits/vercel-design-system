...
export const Icons: Story = {
  ...
  render: () => (
    <Grid.Container gap={1.5}>
      <Grid>
        <Button icon={<User />} auto>
          With Icon
        </Button>
      </Grid>
      <Grid>
        <Button icon={<Shield />} type="success" auto />
      </Grid>
      <Grid>
...
export const Sizes: Story = {
  ...
  render: () => (
    <Grid.Container gap={1.5} alignItems="center">
      <Grid>
        <Button scale={0.5}>Mini</Button>
      </Grid>
      <Grid>
        <Button scale={0.8}>Small</Button>
      </Grid>
      <Grid>
        <Button>Medium</Button>
      </Grid>
      <Grid>
        <Button scale={1.25}>Large</Button>
      </Grid>
      <Grid>
        <Button scale={1.5}>X-Large</Button>
      </Grid>
    </Grid.Container>
  ),
};
