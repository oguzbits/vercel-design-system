...
import { Badge, Avatar, Button, Link, Spacer } from "@/components/ui";
  ...
  render: () => (
    ...
    >
      ...
      <CustomBadgeAnchor badge={<Badge scale={0.5} type="error" dot />}>
        <Link target="_blank" href="https://github.com/geist-org/geist-ui">
          Geist UI
        </Link>
      </CustomBadgeAnchor>
      ...
      <CustomBadgeAnchor
        badge={<Badge type="error" dot style={{ padding: "5px" }} />}
      >
        <Link target="_blank" href="https://github.com/geist-org/geist-ui">
          Share Link
        </Link>
