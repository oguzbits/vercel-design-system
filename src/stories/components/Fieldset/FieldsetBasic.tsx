...
import { Fieldset, Button, Text, Divider } from "@/components/ui";
    ...
    return (
      <Fieldset.Group value="extensible" onChange={handler}>
        <Fieldset label="simple">
          <Fieldset.Title>HTTP is simple</Fieldset.Title>
          <Fieldset.Subtitle>
            HTTP is generally designed to be simple and human readable, even
            with the added complexity introduced in HTTP/2 by encapsulating HTTP
            messages into frames.
          </Fieldset.Subtitle>
          <Fieldset.Footer>
            HTTP Knowledge Base
            <Button auto scale={1 / 3} font="12px">
        ...
        <Fieldset label="stateless">
          ...
          <Fieldset.Subtitle>
            ...
            successively carried out on the same connection.{" "}
          </Fieldset.Subtitle>
          <Fieldset.Footer>
            HTTP Knowledge Base
            <Button auto scale={1 / 3} font="12px">
  ...
  render: () => (
    <Fieldset>
      ...
      <Fieldset.Content>
        ...
        <p>
          To get the most out of this module, you should have worked your way
          through the previous JavaScript modules in the series. Those modules
          typically involve simple API usage, as it is often difficult to write
          client-side JavaScript examples without them.{" "}
        </p>
      </Fieldset.Content>
      <Fieldset.Footer>
