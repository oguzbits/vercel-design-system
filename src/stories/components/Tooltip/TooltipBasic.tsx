...
const CustomTooltip: React.FC<CustomTooltipProps> = ({
  ...
  const [phase, setPhase] = useState<"hidden" | "measuring" | "visible">(
    "hidden",
  );
  ...
  const mouseHandlers =
    trigger === "hover"
      ...
      : {
          onClick: () =>
            setPhase((p) => (p === "hidden" ? "measuring" : "hidden")),
        };
    ...
    ? createPortal(
        <div
          ...
          style={{
            ...
            lineHeight: "1.5",
            boxShadow:
              type === "default" ? "0 4px 14px rgba(0,0,0,.08)" : "none",
            pointerEvents: "none",
            whiteSpace: "nowrap",
            maxWidth: 260,
...
export const Types = {
  ...
  render: () => (
    <Grid.Container gap={2}>
      <Grid>
        <Tooltip text="The compiler tools" type="success">
          Success
        </Tooltip>
      </Grid>
      <Grid>
        <Tooltip text="The compiler tools" type="warning">
          Warning
        </Tooltip>
      </Grid>
      <Grid>
        <Tooltip text="The compiler tools" type="error">
          Error
        </Tooltip>
      </Grid>
      <Grid>
        <Tooltip text="The compiler tools" type="secondary">
          Secondary
        </Tooltip>
      </Grid>
      <Grid>
        <Tooltip text="The compiler tools" type="dark">
          Dark
        </Tooltip>
      </Grid>
      <Grid>
        <Tooltip text="The compiler tools" type="lite">
          Lite
        </Tooltip>
      </Grid>
    </Grid.Container>
...
export const Placement = {
  ...
  render: () => (
    <Grid.Container gap={2} justify="center" style={{ padding: "40px 0" }}>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="topStart">
          topStart
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="top">
          top
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="topEnd">
          topEnd
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="leftStart">
          leftStart
        </Tooltip>
      </Grid>
      <Grid xs={4}></Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="rightStart">
          rightStart
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="left">
          left
        </Tooltip>
      </Grid>
      <Grid xs={4}></Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="right">
          right
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="leftEnd">
          leftEnd
        </Tooltip>
      </Grid>
      <Grid xs={4}></Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="rightEnd">
          rightEnd
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="bottomStart">
          bottomStart
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="bottom">
          bottom
        </Tooltip>
      </Grid>
      <Grid xs={4}>
        <Tooltip text="The compiler tools" placement="bottomEnd">
          bottomEnd
        </Tooltip>
      </Grid>
    </Grid.Container>
