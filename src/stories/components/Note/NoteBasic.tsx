...
export const Filled = {
  ...
  render: () => (
    <>
      <Note type="secondary" filled label={false}>
        This is a filled secondary note.
      </Note>
      <Spacer h={0.5} />
      <Note type="success" filled label={false}>
        This is a filled success note.
      </Note>
      <Spacer h={0.5} />
      <Note type="warning" filled label={false}>
        This is a filled warning note.
      </Note>
      <Spacer h={0.5} />
      <Note type="error" filled label={false}>
        This is a filled error note.
      </Note>
    </>
  ),
};
