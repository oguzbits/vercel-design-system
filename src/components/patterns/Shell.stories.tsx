...
const meta: Meta<typeof Shell> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A standardized application shell used for dashboard and project views. It provides a consistent header with breadcrumbs and user actions.",
      },
    },
  },
};
      ...
      <Tabs initialValue="1">
        ...
        <Tabs.Item label="Infrastructure" value="2">
          ...
          <Note label="Pro Tip" type="secondary">
            Your serverless functions are currently distributed across 3
            regions.
          </Note>
          <Spacer h={1} />
          <div
