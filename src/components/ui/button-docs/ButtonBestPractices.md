...
- **Conciseness**: Make sure it's clear what will happen. Use a single verb where possible (e.g., "Save", "Delete").
- **Case**: Use sentence-style capitalization.
- **Icons**: Use icons only when they add significant value or speed up recognition for common actions (e.g., a "Trash" icon for delete).
