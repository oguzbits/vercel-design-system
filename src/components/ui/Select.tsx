    ...
    <>
      <style
        dangerouslySetInnerHTML={{
          __html:
            ".select input[role='combobox'] { position: absolute !important; top: 0 !important; left: 0 !important; width: 100% !important; height: 100% !important; opacity: 0 !important; z-index: -1 !important; pointer-events: none !important; }",
        }}
      />
      <GeistSelect
        disabled={disabled}
