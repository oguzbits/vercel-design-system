...
const RadioGroup = (props: RadioGroupProps) => {
  ...
  return <GeistRadioGroup useRow={useRow} disabled={disabled} {...(rest as any)} />;
};
...
const RadioComponent = React.forwardRef<any, any>((props, ref) => {
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: ".radio input { position: absolute !important; top: 0 !important; left: 0 !important; opacity: 0 !important; pointer-events: none !important; }" }} />
      <GeistRadio disabled={disabled} checked={checked} {...(cleanProps as any)} />
    </>
  );
});
