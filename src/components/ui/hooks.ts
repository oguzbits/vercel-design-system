...
export const useClipboard = useGeistClipboard;
export const useKeyboard = useGeistKeyboard;
export const useClasses = useGeistClasses;
export const useScale = useGeistScale;
export const withScale = geistWithScale;
